...
| Name | Source | Version |
|------|--------|---------|
| <a name="module_github_action_token_rotator"></a> [github\_action\_token\_rotator](#module\_github\_action\_token\_rotator) | cloudposse/github-action-token-rotator/aws | 0.1.0 |
...
| <a name="input_github_org_name"></a> [github\_org\_name](#input\_github\_org\_name) | SSM parameter name format | `string` | n/a | yes |
...
| <a name="input_parameter_store_private_key_path"></a> [parameter\_store\_private\_key\_path](#input\_parameter\_store\_private\_key\_path) | Path to read the GitHub App private key from parameter store | `string` | n/a | yes |
| <a name="input_parameter_store_token_path"></a> [parameter\_store\_token\_path](#input\_parameter\_store\_token\_path) | Path to store the token in parameter store | `string` | n/a | yes |
